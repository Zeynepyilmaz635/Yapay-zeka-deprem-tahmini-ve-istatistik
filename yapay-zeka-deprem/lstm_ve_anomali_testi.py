...
class Proje(QWidget):
    ...
    def init_ui(self):
        ...
        # Grafik görüntülemek için QLabel ekle
    ...
    def cnn_ile_deprem_haritasi(self):
        ...
        # Grafiği bir dosyaya kaydediyoruz
        plt.savefig('deprem_haritasi.png')
        plt.close()
        
        # Grafiği GUI'de görüntüle
        self.show_image('deprem_haritasi.png')
    ...
    def lstm_anomali_tespiti(self):
        ...
        plt.savefig('lstm_anomali_tespiti.png')
        plt.close()
        
        # Grafiği GUI'de görüntüle
        self.show_image('lstm_anomali_tespiti.png')

    def show_image(self, image_path):
        pixmap = QPixmap(image_path)
        self.graph_label.setPixmap(pixmap.scaled(800, 600))
